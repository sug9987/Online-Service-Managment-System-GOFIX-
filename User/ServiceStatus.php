<!-- //importing or linking common header code// -->
<?php 
define('TITLE' , 'Status');
 ...
 <div class="col-sm-6 mt-5 mx-3">
    <form action="" method="post" class="form-inline d-print-none">
        <div class="form-group mr-3">
            ...
            id="checkid" onkeypress="isInputNumber(event)">
        </div>
        <button text="submit" class="btn btn-info">Search</button>
    </form>
    <?php 
